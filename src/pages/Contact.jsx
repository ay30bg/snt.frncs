      ...
      <div className="contact-container">
        ...
        <div className="contact-grid">
          ...
          <div className="contact-info">
            ...
            <p>
              <a 
                href="https://www.instagram.com/sntfrncs.ww?igsh=dHFwdHgzb3Fmem5y&utm_source=qr" 
                className="icon-link"
              >
                <FaInstagram className="contact-social-icon" />
              </a>
              <a 
                href="https://snapchat.com/t/e55xAlB3" 
                className="icon-link"
              >
                <BsSnapchat className="contact-social-icon" />
              </a>
              <a 
                href="https://x.com/sntfrncs?s=21" 
                className="icon-link"
              >
                <BsTwitterX className="contact-social-icon" />
              </a>
              <a 
                href="https://www.tiktok.com/@sntfrncsww?_t=ZS-8zVQEfyN0uG&_r=1" 
                className="icon-link"
              >
